...
_CONFIG_FNAME = 'shac_network_config.json'
...
def network_config(
    ...
    network_factory: types.NetworkFactory[shac_networks.SHACNetworks],
...
def load_policy(
  ...
  make_inference_fn = shac_networks.make_inference_fn(ppo_network)
